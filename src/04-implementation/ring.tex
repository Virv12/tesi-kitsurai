...
To find the nodes assigned to a key $k$, we compute its starting position
$p = \text{hash}(k) \bmod S$.
Let's say that $p = 2$, then the key is assigned to nodes $r_2 = 2$, $r_3 = 0$,
and $r_4 = 1$ (see Figure~\ref{fig:ring-example}).
