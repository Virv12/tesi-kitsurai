...
built on Karger et al.'s \textit{consistent hashing}~\cite{ConsistentHashing}, gossip-based membership and synchronization powered by a Merkle-tree.
...
Unlike Dynamo's approach to reconciliation, our system does not perform any reconciliation;
instead, it offloads consistency to the user by returning all read values.
