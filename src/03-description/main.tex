...
each node, while permitting a short, bounded burst (on the order of
\SI{100}{\milli\second} to absorb microbursts.
...
gate.
A request exceeding the local budget is going to wait until capacity is
available again.
...
\Kitsurai adopts a conservative, RPS-based (request per second) admission
policy.
...
solid-state drives.
Indeed, a rotational HDDs exhibit seek time and rotational latency that cause
